...
(Note: Naming conventions followed Coursera Getting and Cleaning data guidelines, i.e., all lower case, no dashes or special characters.Even though this means that the column names are very long.) 
